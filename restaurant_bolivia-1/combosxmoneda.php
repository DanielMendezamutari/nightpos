            ...
            <div class="form-group has-feedback"> 
                ...
                <?php } } ?>
                    ...
                    <div class="text-right">
                        <button type="button" id="BotonBusqueda" id="BotonBusqueda" onClick="BuscaCombosxMoneda()" class="btn btn-warning"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
