...
<div class="row">
    ...
    <button type="button" id="BotonBusqueda" onClick="BuscarDetallesCreditosxClientes()" class="btn btn-warning"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
