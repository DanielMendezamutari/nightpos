...
<div id="myModalCaja" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="row">
            <div class="col-md-12"> 
                <div class="form-group has-feedback"> 
                    ...
                    <select style="color:#000;font-weight:bold;" name="codsucursal" id="codsucursal" class="form-control" onChange="CargaHorarios(this.form.codsucursal.value); CargaUsuarios(this.form.codsucursal.value);" required="" aria-required="true">
        ...
        <div class="row">
            <div class="col-md-6"> 
                <div class="form-group has-feedback"> 
                    <label class="control-label">Seleccione Horario: <span class="symbol required"></span></label>
                    <i class="fa fa-bars form-control-feedback"></i>
                    <select style="color:#000;font-weight:bold;" name="codhorario" id="codhorario" class="form-control" required="" aria-required="true">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group has-feedback">
                    ...
                    <?php
                    $horario = new Login();
                    $horario = $horario->ListarHorarios();
                    if($horario==""){ 
                        echo "";
                    } else {
    ...
    <div class="col-lg-12">
        ...
        <form class="form form-material" method="post" action="#" name="cajasxsucursal" id="cajasxsucursal">
            ...
            <div class="text-right">
                <button type="button" id="BotonBusqueda" onClick="BuscaCajasxSucursal()" class="btn btn-warning"><span class="fa fa-search"></span> Realizar Búsqueda</button>
            </div>
