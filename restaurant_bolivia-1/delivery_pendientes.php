    ...
    <div class="col-lg-12">
        ...
        <form class="form form-material" method="post" action="#" name="deliveryxsucursal" id="deliveryxsucursal">
            ...
            <div class="text-right">
                <button type="button" id="BotonBusqueda" onClick="BuscaDeliveryPendientesxSucursal()" class="btn btn-warning"><span class="fa fa-search"></span> Realizar Búsqueda</button>
            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu dropdown-menu-left" x-placement="bottom-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(164px, 35px, 0px);">
                                <?php
                                $delivery = new Login();
                                $delivery = $delivery->ListarRepartidoresxDelivery();
                                if($delivery==""){
                                  echo "";    
                                } else {
