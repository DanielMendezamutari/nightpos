    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group has-feedback">
                ...
                ?>
                <option style="color:#000;font-weight:bold;" value="<?php echo encrypt($caja[$i]['codcaja']) ?>"><?php echo $caja[$i]['hora_desde']." - ".$caja[$i]['hora_hasta']." | ".$caja[$i]['nrocaja'].": ".$caja[$i]['nomcaja']." | ".$caja[$i]['nombres']; ?></option>         
                <?php } } ?>
                </select>    
                <?php } ?>
            </div>
            ...
            <div class="form-group has-feedback">
                ...
                <i class="fa fa-calendar form-control-feedback"></i>
                    ...
                    <div class="text-right">
                        <button type="button" id="BotonBusqueda" onClick="BuscarAbonosCreditosxCajas()" class="btn btn-warning"><span class="fa fa-search"></span> Realizar Búsqueda</button>
                    </div>
                </div>
            </div>
        </form>
