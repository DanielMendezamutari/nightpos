    ...
    <div class="col-lg-12">
        ...
        <form class="form form-material" method="post" action="#" name="pedidosxsucursal" id="pedidosxsucursal">
            ...
            <div class="text-right">
                <button type="button" id="BotonBusqueda" onClick="BuscaPedidosxSucursal()" class="btn btn-warning"><span class="fa fa-search"></span> Realizar Búsqueda</button>
            </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="form-body">
                ...
                <form class="form form-horizontal" method="post" action="#" name="busquedapedidos" id="busquedapedidos">

                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group has-feedback4">
                        <label class="control-label">Búsqueda de Pedidos: <span style="cursor: pointer;" class="mdi mdi-alert-circle text-danger" data-container="body" title="Notificación: Ingrese Criterio de Búsqueda por Nº de Factura, Nº Documento de Cliente, Nombres de Cliente, Nº de Sucursal, Nombre de Sucursal."></span></label>
                        <input type="hidden" id="BotonBusqueda" onClick="BuscarPedidos()">
                        <input type="text" class="form-control input-search" name="bpedidos" id="bpedidos" onKeyUp="this.value=this.value.toUpperCase();" placeholder="Ingrese Criterio para tu Búsqueda (Dar Enter)" autocomplete="off" autocomplete="off" required="" aria-required="true"> 
