...
final class ExportCompanionRankingPdfController extends Controller
{
    ...
    public function __invoke(Request $request): SymfonyResponse
    {
        ...
        $rows = $query->groupBy('companions.id', 'companions.stage_name')
        ...
        $pdf = Pdf::loadView('pdf.companion-ranking', [
        ...
        return $pdf->download('reporte-ranking-chicas-'.$suffix.'.pdf');
    }
}
