...
/**
 * Turnos recientes de la sucursal activa, para elegir alcance en reportes (dueño/super_admin con ?site_id=).
 */
final class ListReportShiftTurnsController extends Controller
{
