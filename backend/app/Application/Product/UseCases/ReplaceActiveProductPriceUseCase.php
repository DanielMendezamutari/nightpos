...
final class ReplaceActiveProductPriceUseCase implements UseCaseInterface
{
    ...
    public function execute(?object $input = null): OperationResult
    {
        ...
        $price = DB::transaction(function () use ($tenant, $branchId, $input, $product, $saleMode) {
            $this->prices->deactivateActiveForSaleMode(
                $tenant->id,
                $product->id,
                $branchId,
                $saleMode,
        ...
        return OperationResult::ok('Precio actualizado correctamente.', [
