...

{
...

    {
        ...
        return [
            ...
            'settlement_behavior' => $product->settlementBehavior,

            'bracelet_units_per_line' => $product->braceletUnitsPerLine,

            'requires_allocation' => $product->requiresAllocation,

            'allocation_type' => $product->allocationType,
