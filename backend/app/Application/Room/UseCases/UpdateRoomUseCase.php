...
final class UpdateRoomUseCase implements UseCaseInterface
{
    ...
    {
        if (! $input instanceof UpdateRoomInput) {
        ...
        if ($code === '' || $this->rooms->codeExists($tenant->id, $branch->id, $code, $input->roomId)) {
        ...
        return OperationResult::ok('Habitación actualizada.', ['room' => $room]);
    }
}
