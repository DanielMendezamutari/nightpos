...
final class ListAvailableRoomsUseCase implements UseCaseInterface
{
    ...
    public function execute(?object $input = null): OperationResult
    {
        ...
        return OperationResult::ok('Habitaciones disponibles.', [
            'items' => $this->rooms->listAvailable($tenant->id, $branch->id),
        ]);
    }
}
