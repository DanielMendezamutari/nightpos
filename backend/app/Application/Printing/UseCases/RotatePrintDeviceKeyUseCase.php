...
final class RotatePrintDeviceKeyUseCase implements UseCaseInterface
{
    ...
    public function execute(?object $input = null): OperationResult
    {
        ...
        $updated = $this->devices->rotateKey($deviceId, $tenant->id, $branch->id, $key['hash'], $key['prefix']);

        return OperationResult::ok('Clave rotada. Guarde la nueva clave; no se volverá a mostrar.', [
            'device' => $updated,
