...
final class GetDailyReportUseCase implements UseCaseInterface
{
    ...
    public function execute(?object $input = null): OperationResult
    {
        ...
        $data    = $this->reports->getDailySummary($tenant->id, $branch->id, $filters);

        return OperationResult::ok('Reporte diario.', $data);
    }
