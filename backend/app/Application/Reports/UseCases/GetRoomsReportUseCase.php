...
final class GetRoomsReportUseCase implements UseCaseInterface
{
    ...
    public function execute(?object $input = null): OperationResult
    {
        ...
        $data    = $this->reports->getRoomsReport($tenant->id, $branch->id, $filters);

        return OperationResult::ok('Reporte de habitaciones.', $data);
    }
