...
final class GetCashReportUseCase implements UseCaseInterface
{
    ...
    public function execute(?object $input = null): OperationResult
    {
        ...
        $data    = $this->reports->getCashReport($tenant->id, $branch->id, $filters);

        return OperationResult::ok('Reporte de caja.', $data);
    }
