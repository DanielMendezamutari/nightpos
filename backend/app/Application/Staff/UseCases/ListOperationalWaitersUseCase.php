...
final class ListOperationalWaitersUseCase implements UseCaseInterface
{
    ...
    public function execute(?object $input = null): OperationResult
    {
        ...
        $items = UserModel::query()
            ...
            ->map(static fn (UserModel $user) => [
                ...
                'waiter_commission_percent' => $user->staffProfile?->waiter_commission_percent,
            ])
            ->all();

        return OperationResult::ok('Garzones.', ['items' => $items]);
    }
}
