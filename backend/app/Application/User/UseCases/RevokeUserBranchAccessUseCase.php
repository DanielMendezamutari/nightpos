...
final class RevokeUserBranchAccessUseCase implements UseCaseInterface
{
    ...
    public function execute(?object $input = null): OperationResult
    {
        ...
        $this->users->revokeBranchAccess($input->userId, $tenant->id, $input->branchId);
        ...
        return OperationResult::ok('Sucursal removida correctamente.', [
