...
final class ListDueRoomServicesUseCase implements UseCaseInterface
{
    ...
    public function execute(?object $input = null): OperationResult
    {
        ...
        return OperationResult::ok('Piezas con tiempo cumplido.', [
            'items' => $this->roomServices->listDue($tenant->id, $branch->id),
            'due_count' => count($this->roomServices->listDue($tenant->id, $branch->id)),
        ]);
    }
}
