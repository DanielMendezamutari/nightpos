...
public function test_can_login_with_password(): void { $response = $this->postJson('/api/v1/auth/login-password', ['username' => 'admin.demo', 'password' => 'AdminDemo123!', 'tenant_slug' => 'casa-demo']); $response->assertOk()->assertJsonPath('success', true)->assertJsonStructure(['data' => ['token']]); }
