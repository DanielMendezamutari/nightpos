...
export default [
  ...
  { heading: 'Configuración', requiresOperationalContext: true },
  {
    ...
    requiresOperationalContext: true,
    children: [
      { title: 'Métodos de pago', to: 'nightpos-settings-payments' },
      { title: 'Motivos de caja', to: 'nightpos-settings-cash-reasons' },
      { title: 'Ambientes', to: 'nightpos-settings-service-areas' },
      { title: 'Tipos habitación', to: 'nightpos-settings-room-types' },
      { title: 'Checklist 1ª noche', to: 'nightpos-settings-first-night-checklist' },
