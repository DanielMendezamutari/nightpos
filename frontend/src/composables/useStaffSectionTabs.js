...
export const PLATFORM_SECTION_TABS = [
  ...
  { title: 'Config', value: 'settings', to: 'nightpos-platform-settings', icon: 'ri-settings-3-line' },
]

export const CATALOG_SECTION_TABS = [
  { title: 'Productos', value: 'products', to: 'nightpos-products', icon: 'ri-goblet-line' },
  { title: 'Sin precio', value: 'unpriced', to: 'nightpos-products-unpriced', icon: 'ri-error-warning-line' },
  { title: 'Categorías', value: 'categories', to: 'nightpos-categories', icon: 'ri-folder-line' },
  { title: 'Precios', value: 'prices', to: 'nightpos-catalog-prices', icon: 'ri-price-tag-3-line' },
]
