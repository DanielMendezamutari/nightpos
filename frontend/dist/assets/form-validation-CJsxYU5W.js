...
`},X=S("p",null,[y("Use "),S("code",null,"Rules"),y(" prop to validate the input.")],-1),me={__name:"form-validation",setup(T){return(w,b)=>{const C=H,t=J,u=G,f=z;return q(),g(P,null,{default:o(()=>[l(d,{cols:"12"},{default:o(()=>[l(t,{title:"Simple Form Validation",code:K},{default:o(()=>[X,l(C)]),_:1},8,["code"])]),_:1}),l(d,{cols:"12"},{default:o(()=>[l(t,{title:"Validating Multiple Rules",code:Q},{default:o(()=>[l(u)]),_:1},8,["code"])]),_:1}),l(d,{cols:"12"},{default:o(()=>[l(t,{title:"Validation Types",code:W},{default:o(()=>[l(f)]),_:1},8,["code"])]),_:1})]),_:1})}}};export{me as default};
