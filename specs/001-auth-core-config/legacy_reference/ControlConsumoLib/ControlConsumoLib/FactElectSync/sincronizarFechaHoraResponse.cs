...
[MessageContract(WrapperName = "sincronizarFechaHoraResponse", WrapperNamespace = "https://siat.impuestos.gob.bo/", IsWrapped = true)]
public class sincronizarFechaHoraResponse
{
	...
	public sincronizarFechaHoraResponse(respuestaFechaHora RespuestaFechaHora)
	{
