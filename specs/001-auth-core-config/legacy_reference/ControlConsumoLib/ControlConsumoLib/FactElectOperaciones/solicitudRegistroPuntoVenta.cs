...
public class solicitudRegistroPuntoVenta : INotifyPropertyChanged
{
	...
	public int codigoTipoPuntoVenta
	{
		get
		{
			return codigoTipoPuntoVentaField;
		}
		set
		{
			codigoTipoPuntoVentaField = value;
			RaisePropertyChanged("codigoTipoPuntoVenta");
		}
	}
