...
public class respuestaConsultaPuntoVenta : modelDto
{
	...
	[XmlElement("listaPuntosVentas", Form = XmlSchemaForm.Unqualified, IsNullable = true, Order = 0)]
	public puntosVentasDto[] listaPuntosVentas
	{
		get
		{
			return listaPuntosVentasField;
		}
		set
		{
			listaPuntosVentasField = value;
			RaisePropertyChanged("listaPuntosVentas");
		}
	}
