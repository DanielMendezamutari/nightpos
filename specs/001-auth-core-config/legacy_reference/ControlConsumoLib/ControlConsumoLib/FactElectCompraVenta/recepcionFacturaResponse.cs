...
[MessageContract(WrapperName = "recepcionFacturaResponse", WrapperNamespace = "https://siat.impuestos.gob.bo/", IsWrapped = true)]
public class recepcionFacturaResponse
{
	...
	public recepcionFacturaResponse(respuestaRecepcion RespuestaServicioFacturacion)
	{
