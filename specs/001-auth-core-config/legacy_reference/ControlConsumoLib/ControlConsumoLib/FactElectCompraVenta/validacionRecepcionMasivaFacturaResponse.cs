...
[MessageContract(WrapperName = "validacionRecepcionMasivaFacturaResponse", WrapperNamespace = "https://siat.impuestos.gob.bo/", IsWrapped = true)]
public class validacionRecepcionMasivaFacturaResponse
{
	...
	public validacionRecepcionMasivaFacturaResponse(respuestaRecepcion RespuestaServicioFacturacion)
	{
