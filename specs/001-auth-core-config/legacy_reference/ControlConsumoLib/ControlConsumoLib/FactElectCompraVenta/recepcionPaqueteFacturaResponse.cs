...
[MessageContract(WrapperName = "recepcionPaqueteFacturaResponse", WrapperNamespace = "https://siat.impuestos.gob.bo/", IsWrapped = true)]
public class recepcionPaqueteFacturaResponse
{
	...
	public recepcionPaqueteFacturaResponse(respuestaRecepcion RespuestaServicioFacturacion)
	{
