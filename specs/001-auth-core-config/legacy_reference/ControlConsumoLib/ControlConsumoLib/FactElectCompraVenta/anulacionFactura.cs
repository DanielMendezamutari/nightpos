...
[MessageContract(WrapperName = "anulacionFactura", WrapperNamespace = "https://siat.impuestos.gob.bo/", IsWrapped = true)]
public class anulacionFactura
{
	...
	public anulacionFactura(solicitudAnulacion SolicitudServicioAnulacionFactura)
	{
