...
public class respuestaCufdMasivo : modelDto
{
	...
	[XmlElement("listaRespuestasCufd", Form = XmlSchemaForm.Unqualified, IsNullable = true, Order = 0)]
	public respuestaListaRegistroCufdSoapDto[] listaRespuestasCufd
	{
		get
		{
			return listaRespuestasCufdField;
		}
		set
		{
			listaRespuestasCufdField = value;
			RaisePropertyChanged("listaRespuestasCufd");
		}
	}
