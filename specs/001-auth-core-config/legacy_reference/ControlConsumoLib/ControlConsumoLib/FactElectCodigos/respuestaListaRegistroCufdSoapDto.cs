...
public class respuestaListaRegistroCufdSoapDto : INotifyPropertyChanged
{
	...
	[XmlElement("mensajeServicioList", Form = XmlSchemaForm.Unqualified, IsNullable = true, Order = 7)]
